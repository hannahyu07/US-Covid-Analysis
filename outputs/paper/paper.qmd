...
date: today
date-format: long
abstract: "The COVID-19 pandemic has exposed deep disparities in health outcomes across different states and counties in the United States. We use data from the American Economic Association to conduct a comprehensive analysis of how variances in local health infrastructure and socio-political factors within the United States contributed to disparities in COVID-19 outcomes. Our analysis reveals that political polarization significantly influenced adherence to health guidelines, with Republican-leaning states demonstrating slightly higher clustering around elevated death rates. Moreover, social vulnerabilities, including disparities in healthcare access, housing conditions, and ethnic demographics, emerged as key contributors to substantial variations in disease outcomes. These results highlight the urgent requirement for customized public health readiness and response tactics, focusing on precise interventions to tackle deficiencies in community health infrastructure and socio-political factors."
format: pdf
