...
The datasets utilized in this paper were mainly obtained from the `original paper` [@citearticle]. The data used by the paper was compiled from various sources such as the @data1, @data2, @data3, @data4, @data5, @data6, @data7, @data8, @data9, @data10, and @data11. Additionally, to address the original paper's lack of US COVID statistics and political party support data, we incorporated information from @citedata1 and [@citedata2]. The political party support data we utilized from @citedata1 was compiled from @data12. 
